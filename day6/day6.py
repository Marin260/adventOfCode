...
# pretty sure i can improve the logic in the main for loop and skip and avoid everything from line 9-17
...
for i in range(9): # add the keys of the days that do not exist
    try:
        ...
        listOfFishDays[i] = 0
listOfFishDays = dict(sorted(listOfFishDays.items())) # no need for this at all, just for a later visual rep

for i in range(256): # main for loop logic 
